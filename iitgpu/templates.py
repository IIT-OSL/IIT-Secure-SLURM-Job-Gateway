...
_BUILTIN_PRESETS: dict[str, dict] = {
    "LLM Fine-tune (A100 x4)": {
        ...
        "mem_gb": 64,
        "time_limit": "24:00:00",
        "run_command": "python finetune.py --model $MODEL_PATH --epochs 3",
    ...
    "Inference / Serving": {
        ...
        "mem_gb": 16,
        "time_limit": "04:00:00",
        "run_command": "python serve.py --model $MODEL_PATH --port 8080",
        "modules": ["CUDA/11.8", "Python/3.11"],
        "uploads": [],
        "model_path": "",
        "conda_env": "",
    ...
    "Training from Scratch": {
        "job_name": "train_scratch",
        "partition": "gpu-long",
        "gpus": 8,
        "cpus": 32,
        "mem_gb": 128,
        "time_limit": "72:00:00",
        "run_command": "torchrun --nproc_per_node=8 train.py --config config.yaml",
        "modules": ["CUDA/11.8", "Python/3.11"],
        "uploads": [],
        "model_path": "",
        "conda_env": "",
